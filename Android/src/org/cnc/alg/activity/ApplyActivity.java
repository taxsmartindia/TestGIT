...
public class ApplyActivity extends Activity {
	...
	private OnClickListener sendClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			networkStatus = new NetworkStatus(ApplyActivity.this);
			dialogManager = new DialogManager(ApplyActivity.this);
	...
	private OnClickListener backClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(ApplyActivity.this, HomeScreenActivity.class);
			finish();
	...
	class SendMail extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			edtYourMail.setText("");
			if (this.result != null) {
				Toast.makeText(ApplyActivity.this, Constant.MAIL_SEND, Toast.LENGTH_SHORT).show();
			} else {
				Toast.makeText(ApplyActivity.this, Constant.MAIL_SEND_FAIL, Toast.LENGTH_SHORT).show();
			}
