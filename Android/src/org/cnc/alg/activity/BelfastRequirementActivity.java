 ...
 * 
 */
public class BelfastRequirementActivity extends Activity  {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);

		setContentView(R.layout.belfast_req);
		// Diplay html
		showHtmlContent(1, "file:///android_asset/belfast_requirement.html");
