...
public class TraineeLookForActivity extends Activity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        boolean customTitle = requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        setContentView(R.layout.trainee_look_for);
        if (customTitle) {
			getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE,
					R.layout.customtitle);
			((TextView) findViewById(R.id.txtTitle)).setText(Constant.TRAINEE_LOOKING_FOR);
		...
		// Diplay html
		showHtmlContent("file:///android_asset/lookfor.html");
	}
	...
	private void showHtmlContent(String url) {
		WebView tv = (WebView) findViewById(R.id.text_traineelookfor);
	...
	private OnClickListener backOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			Intent intent = new Intent(TraineeLookForActivity.this,
...
//        getMenuInflater().inflate(R.menu.trainee_look_for, menu);
//        return true;
//    }
}
